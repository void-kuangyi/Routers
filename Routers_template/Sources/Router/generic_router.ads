...
package Generic_Router is
   ...
   type Messages_routertables is array (Router_Range) of Messages_routertable;
   ...
   task type Router_Task (Task_Id  : Router_Range := Draw_Id) is
      ...
      entry Exchangeroutertable (Message : Messages_routertables);

      entry Receive_intermessage (Message :   Messages_inter);
